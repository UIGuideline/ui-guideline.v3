...
export const SYSTEM_LOGOS: Record<SystemSlug, string> = {
  ...
  [SystemSlug.mantine]: '/assets/systems/thumbnails/contained/mantine.svg',
  [SystemSlug.mui]: '/assets/systems/thumbnails/contained/mui.svg',
